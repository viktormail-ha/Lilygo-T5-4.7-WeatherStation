...
6. If needed, open src/OWM_EPD47.ino in Visual Studio Code and modify the weather update schedule in lines 71-76 (by default, the weather is updated every 30 minutes, and the device enters sleep mode daily from 03:00 to 06:00)
